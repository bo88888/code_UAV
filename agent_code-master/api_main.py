...
def web_console():
    for filename in (
        "index_medical_dispatch_console.html",
        "index_offline_map.html",
        "index_leaflet_map.html",
        "index_realtime_map_v2.html",
    ...
    return {
        ...
        "message": "请确认 frontend/index_medical_dispatch_console.html 已存在。",
    }
